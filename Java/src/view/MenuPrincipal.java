	...
	private void initEvents() {
		...
		jMenu6.addMouseListener(new MouseListener() {
			public void mousePressed(MouseEvent arg0) {
				// Cierra el Sistema
				int seguro = JOptionPane.showConfirmDialog(null, "�Est� seguro que desea salir?", "Atenci�n!", JOptionPane.YES_NO_OPTION);
			...
			{
				{
					...
					jPanel1.setLayout(null);
					{
						...
						jl_Duracion.setText("Duraci�n / Inmovilizaci�n del Capital :");
					...
					}
					{
						ComboBoxModel jcb_DuracionModel = new DefaultComboBoxModel(
							new String[] { "<seleccione periodo>", "Dia", "Semana", "Mes", "A�o" });
