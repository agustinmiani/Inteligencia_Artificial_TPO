(deftemplate Requisitos
		(slot duracion (type SYMBOL) (allowed-symbols Dia Semana Mes Anio NA) (default NA))
		(slot riesgo (type SYMBOL)(allowed-symbols Minimo Bajo Medio Alto) (default ?NONE))
		(slot ganancia (type NUMBER) (default 0))
)
...
(deftemplate Inversion
		...
		(slot inversionSugerida (type SYMBOL)(allowed-symbols 
									Plazos_Fijos 
									Plazos_Fijos_Indexados_Por_CER
									Bonos_Estatales 
									Bonos_Corporativos_En_Dolares
									Lebacs 
									Fondos_De_Inversion_Tasa_Fija 
									Lettes 
									Fondos_De_Inversion_Tasa_Variable
									Cauciones_En_Dolares 
									Cauciones_En_Pesos 
									Commodities 
									Indices 
									Acciones 
...
(defrule Regla_RMIN
		...
		=>
     	...
     	(assert (Regla_Ejecutada (id_regla "Regla_RMIN") (descripcion "Riesgo -> Minimo")))
...
(defrule Regla_RBAJ
		...
		=>
     	...
     	(assert (Regla_Ejecutada (id_regla "Regla_RBAJ") (descripcion "Riesgo -> Bajo")))
...
(defrule Regla_RMED
		...
		=>
     	...
     	(assert (Regla_Ejecutada (id_regla "Regla_RMED") (descripcion "Riesgo -> Medio")))
...
(defrule Regla_RALT
		...
		=>
     	...
     	(assert (Regla_Ejecutada (id_regla "Regla_RALT") (descripcion "Riesgo -> Alto")))
...
(defrule Regla_YYAMIN10
    	...
    	(assert (Regla_Ejecutada (id_regla "Regla_YYAMIN10") (descripcion "Riesgo -> Minimo, Duracion -> Anio, 10%<Ganancia<20%")))
     	(printout t "La Inversion Sugerida es Plazos Fijos" crlf)
     	(printout t "La Inversion Sugerida es Plazos Fijos Indexados por CER" crlf))
...
(defrule Regla_YYMED20
		...
		=>
     	...
     	(assert (Regla_Ejecutada (id_regla "Regla_YYMED20") (descripcion "Riesgo -> Medio, Duracion -> Anio, 20%<Ganancia<30%")))
     	(printout t "La Inversion Sugerida es Fondos de inversion tasa fija" crlf)
     	(printout t "La Inversion Sugerida es Lettes" crlf)
     	(printout t "La Inversion Sugerida es Fondos de inversion tasa variable" crlf)
...
(defrule Regla_YYALT20
    	...
    	(assert (Regla_Ejecutada (id_regla "Regla_YYALT20") (descripcion "Riesgo -> Alto, Duracion -> Anio, 30%<Ganancia<50%")))
     	(printout t "La Inversion sugerida es Acciones" crlf))
...
(defrule Regla_YYALT50
		...
		=>
 		...
 		(assert (Regla_Ejecutada (id_regla "Regla_YYALT50") (descripcion "Riesgo -> Alto, Duracion -> Anio, Ganancia>50%")))
...
(defrule Regla_MMMINO
    	...
    	(assert (Regla_Ejecutada (id_regla "Regla_MMMINO") (descripcion "Riesgo -> Minimo, Duracion -> Mes, 0%<Ganancia<5%")))
     	(printout t "La inversion sugerida es Plazos Fijos" crlf)
     	(printout t "La inversion sugerida es Plazos Fijos Indexados por CER" crlf))
...
(defrule Regla_MMBAJO
		...
		=>
     	...
     	(assert (Regla_Ejecutada (id_regla "Regla_MMBAJO") (descripcion "Riesgo -> Bajo, Duracion -> Mes, 0%<Ganancia<5%")))
      	(printout t "La inversion sugerida es Bonos Estatales" crlf)
      	(printout t "La inversion sugerida es Bonos Corporativos en dolares" crlf)
      	(printout t "La inversion sugerida es Lebacs" crlf))
...
(defrule Regla_MMMEDO
		...
		=>
  		...
  		(assert (Regla_Ejecutada (id_regla "Regla_MMMEDO") (descripcion "Riesgo -> Medio, Duracion -> Mes, 0%<Ganancia<5%")))
     	(printout t "La Inversion Sugerida es Fondos de Inversion Tasa Fija" crlf)
     	(printout t "La Inversion Sugerida es Fondos de Inversion Tasa Variable" crlf)
     	(printout t "La Inversion Sugerida es Cauciones en dolares" crlf)
     	(printout t "La Inversion Sugerida es Cauciones en pesos" crlf)
...
(defrule Regla_MMMED5
		...
		=>
   		...
   		(assert (Regla_Ejecutada (id_regla "Regla_MMMED5") (descripcion "Riesgo -> Medio, Duracion -> Mes, 5%<Ganancia<10%")))
     	(printout t "La Inversion Sugerida es Indices" crlf))
...
(defrule Regla_MMALT5
		...
		=>
     	...
     	(assert (Regla_Ejecutada (id_regla "Regla_MMALT5") (descripcion "Riesgo -> Alto, Duracion -> Mes, 5%<Ganancia<10%")))
        (printout t "La Inversion Sugerida es ADR" crlf)
     	(printout t "La Inversion Sugerida es Futuros" crlf))
...
(defrule Regla_MMALT10
		...
		=>
     	...
     	(assert (Regla_Ejecutada (id_regla "Regla_MMALT10") (descripcion "Riesgo -> Alto, Duracion -> Mes, 10%<Ganancia<20%")))
     	(printout t "La inversion sugerida es Acciones" crlf))
...
(defrule Regla_MMALT30
    	...
    	(assert (Regla_Ejecutada (id_regla "Regla_MMALT30") (descripcion "Riesgo -> Alto, Duracion -> Mes, 30%<Ganancia<50%")))
       	(printout t "La Inversion sugerida es Opciones" crlf))
...
(defrule Regla_DDMEDO
    	...
    	(assert (Regla_Ejecutada (id_regla "Regla_DDMEDO") (descripcion "Riesgo -> Medio, Duracion -> Dia o Semana, 0%<Ganancia<5%")))
       	(printout t "La inversion sugerida es Indices" crlf))
...
(defrule Regla_DDMEDO2
    	...
    	(assert (Regla_Ejecutada (id_regla "Regla_DDMEDO2") (descripcion "Riesgo -> Alto, Duracion -> Dia o Semana, 0%<Ganancia<5%")))
       	(printout t "La inversion sugerida es Acciones" crlf)
...
(defrule Regla_DDALT5
		...
		(assert (Regla_Ejecutada (id_regla "Regla_DDALT5") (descripcion "Riesgo -> Alto, Duracion -> Dia, 5%<Ganancia<10%")))
		(printout t "La inversion sugerida es Opciones" crlf))
...
(defrule Regla_WWALT10
		...
		(assert (Regla_Ejecutada (id_regla "Regla_WWALT10") (descripcion "Riesgo -> Alto, Duracion -> Semana, 10%<Ganancia<20%")))
		(printout t "La Inversion Sugerida es Opciones" crlf))
